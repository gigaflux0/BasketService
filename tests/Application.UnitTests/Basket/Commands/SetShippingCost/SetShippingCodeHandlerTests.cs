...
namespace Application.UnitTests.Basket.Commands.SetShippingCost;

[TestFixture]
public class SetShippingCostHandlerTests
{
    private Fixture _fixture = null!;
    private IBasketRepository _repository = null!;
    private SetShippingCostHandler _handler = null!;
    ...
    public void SetUp()
    {
        ...
        _handler = new SetShippingCostHandler(_repository);
    }

    [Test]
    public async Task Handle_WhenBasketDoesNotExist_ReturnsFailure()
    {
        var command = _fixture.Create<SetShippingCostCommand>();
    ...
    [Test]
    public async Task Handle_WhenBasketExists_SetsShippingCostAndSavesEvents()
    {
        var command = _fixture.Create<SetShippingCostCommand>();
        var streamId = $"basket-{command.BasketId}";
